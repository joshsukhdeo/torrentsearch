...
module.exports = {
  search: function(query, rarbg_api_url, cat, page, limit) {
    ...
    //get token
    var url = rarbg_api_url + "/pubapi_v2.php?get_token=get_token&app_id=anujyadav";
    ...
    request(options, function (err, response, body) {
        ...
        if (!err && response.statusCode === 200) {
            ...
            var search_url = rarbg_api_url + "/pubapi_v2.php?mode=search&search_string=" + encodeURIComponent(search_query) + "&app_id=anujyadav&sort=seeders&format=json_extended&token=" + token;
